...
export const ERROR_GUIDE: Record<ErrorCode, string> = {
  ...
  CHAT_NOT_FOUND: "No such chat is known. Call list_chats or find_contact to get a valid chat_id.",
  MESSAGE_NOT_FOUND: "No such message is loaded. Use a message_id from read_messages or search.",
  CONTACT_NOT_FOUND: "No such contact is known. Call find_contact first.",
